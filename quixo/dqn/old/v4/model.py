...
class Policy(torch.nn.Module):
    def __init__(self, state_space, action_space):
        ...
        self.hidden = 64
        # Layers
        self.f1 = torch.nn.Linear(self.state_space, self.hidden)
        self.f2 = torch.nn.Linear(self.hidden, self.hidden)
        self.f3 = torch.nn.Linear(self.hidden, self.action_space)
        self.init_weights()
